...
<div class="relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mb-6 border border-foreground/[0.08] bg-foreground/[0.08] gap-px overflow-hidden">
  ...
  <a class="contents" href="docs/tools.html#tool-review-code">
    <div class="group/card relative p-4 lg:p-5 min-h-[100px] transition-all duration-200 hover:bg-foreground/[0.02] hover:shadow-[inset_0_1px_0_0_rgba(128,128,128,0.1)] hover:z-10 bg-background">
      ...
      <div class="mt-3 flex items-center gap-1.5">
        <div class="flex items-center h-5 px-2 border border-foreground/[0.08] bg-foreground/[0.02] flex-1 min-w-0">
          <span class="text-[9px] font-mono text-purple-400 mr-1.5">AST</span>
          <span class="text-[9px] font-mono text-foreground/50 dark:text-foreground/35 truncate">ast.Call(stripe.charge)</span>
        </div>
        <div class="flex items-center h-5 px-2 border border-foreground/[0.08] bg-foreground/[0.02] flex-1 min-w-0">
          <span class="text-[9px] font-mono text-emerald-400 mr-1.5">CONF</span>
          <span class="text-[9px] font-mono text-foreground/50 dark:text-foreground/35">0.91 [CRITICAL]</span>
        </div>
      </div>
    </div>
  </a>
    ...
    <div class="group/card relative p-4 lg:p-5 min-h-[100px] transition-all duration-200 hover:bg-foreground/[0.02] hover:shadow-[inset_0_1px_0_0_rgba(128,128,128,0.1)] hover:z-10 bg-background">
      ...
      <div class="mt-3 flex items-center gap-2.5">
        <div class="flex -space-x-1.5">
          <div class="size-5 rounded-full border border-foreground/10 bg-neutral-900 flex items-center justify-center text-[8px] font-mono z-[3]">A</div>
          <div class="size-5 rounded-full border border-foreground/10 bg-neutral-900 flex items-center justify-center text-[8px] font-mono z-[2]">I</div>
          <div class="size-5 rounded-full border border-foreground/10 bg-neutral-900 flex items-center justify-center text-[8px] font-mono z-[1]">T</div>
        ...
        <div class="flex items-center gap-1">
          <span class="text-[8px] font-mono text-red-400 px-1.5 py-0.5/20 bg-red-500/5">CRITICAL</span>
          <span class="text-[8px] font-mono text-orange-400 px-1.5 py-0.5 border border-orange-500/20 bg-orange-500/5">HIGH</span>
          <span class="text-[8px] font-mono text-yellow-400 px-1.5 py-0.5 border border-yellow-500/20 bg-yellow-500/5">MEDIUM</span>
        </div>
      </div>
    </div>
  </a>
  ...
  <a class="contents" href="docs/index.html">
    <div class="group/card relative p-4 lg:p-5 min-h-[100px] transition-all duration-200 hover:bg-foreground/[0.02] hover:shadow-[inset_0_1px_0_0_rgba(128,128,128,0.1)] hover:z-10 bg-background">
      ...
      <div class="mt-3 flex items-center h-5 px-2.5 border border-foreground/[0.06] bg-foreground/[0.015] font-mono text-[8px] gap-1">
        <span class="text-foreground/30">$</span>
        <span class="text-foreground/70">failures.audit(ast)</span>
        <span class="text-foreground/30">→</span>
        <span class="text-emerald-400"><span class="inline-flex items-center gap-1">0 findings <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></span></span>
        <span class="inline-block w-px h-2.5 bg-foreground/30 animate-[blink_1s_steps(2)_infinite]"></span>
      </div>
    </div>
  </a>
  ...
  <a class="contents" href="docs/examples.html">
    <div class="group/card relative p-4 lg:p-5 min-h-[100px] transition-all duration-200 hover:bg-foreground/[0.02] hover:shadow-[inset_0_1px_0_0_rgba(128,128,128,0.1)] hover:z-10 bg-background">
      ...
      <div class="mt-3 flex items-center gap-1.5 font-mono text-[8px]">
        <div class="flex items-center gap-1 px-1.5 py-0.5/20 bg-red-500/5">
          <span class="size-1 rounded-full bg-red-400"></span>
          <span class="text-red-400">CRITICAL (0.91)</span>
        </div>
        <div class="flex items-center gap-1 px-1.5 py-0.5 border border-amber-500/20 bg-amber-500/5">
          <span class="size-1 rounded-full bg-amber-400"></span>
          <span class="text-amber-400">HIGH (0.84)</span>
        </div>
        <div class="flex items-center gap-1 px-1.5 py-0.5 border border-emerald-500/20 bg-emerald-500/5">
    ...
    <div class="relative text-foreground" data-v="1">
      <div class="flex flex-col lg:flex-row gap-0">
        ...
        <div class="ba-sticky-left relative w-full lg:w-[40%] lg:h-[calc(100vh-45px)] lg:border-r border-foreground/[0.06] px-5 sm:px-6 lg:px-7 lg:sticky lg:top-[45px] z-10 bg-background lg:overflow-clip">
          ...
          <div class="flex justify-center h-full absolute items-center left-[18%] lg:left-[22%] w-full max-w-[400px] lg:max-w-[360px] pointer-events-auto select-none animate-logo-reveal z-[2] opacity-100">
                      <div class="group relative max-w-[360px] w-full flex justify-center opacity-100 -mt-[28%] lg:-mt-[44%]">
...
<body>
  ...
  <div class="ba-docs-layout" style="padding-top:45px;">
    ...
    <main class="ba-docs-content ba-prose">
      ...
      <p><strong>Naive Payment Handler (3 CRITICAL, 1 HIGH):</strong></p>
      <div class="ba-code-block">
